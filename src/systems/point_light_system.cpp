...
namespace vhl 
{
    ...
    void PointLightSystem::update(FrameInfo& frameInfo, UniformDataScene& ubo)
    {
    ...
    void PointLightSystem::render(FrameInfo& frameInfo, DescriptorSets& bindingDescriptorSets)
    {
        m_VhlPipeline->bind(frameInfo.commandBuffer);
